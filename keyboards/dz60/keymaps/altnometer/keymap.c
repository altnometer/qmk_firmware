...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FN1] = LAYOUT(
		...
		KC_GRV , KC_LBRC, KC_UNDS, KC_MINS, KC_EQL , KC_PLUS, _______, KC_DOT , KC_8   , KC_9   , KC_7   , _______, _______, _______,
		_______, KC_RBRC, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_ENT , KC_1   , KC_2   , KC_3   , KC_0   , _______, _______,
