...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LALT, KC_LCTL, KC_LGUI, KC_SPC , KC_SPC , KC_SPC , KC_RALT, MO(2)  , KC_NO  , MO(1)  , KC_RCTL),
   ...
   */
	LAYOUT(
		...
		_______, _______, _______, _______, _______, _______, KC_RIGHT, KC_DOWN, KC_UP , KC_LEFT, _______, _______, _______, 
