...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* LAYOUT : Second Layer (WASD and Media)
   * ,-----------------------------------------------------------.
   * |ESC| F1| F2| F3  |   |   |   |   |   |   |   |   |   | DEL |
   * |-----------------------------------------------------------|
   * |     |   |   |   |   |   |   |   |   |   |   |   |   |     |
   ...
   */
	[_FN1] = LAYOUT(
		...
		_______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP , KC_RIGHT, KC_LBRC, KC_RBRC, KC_BSPC,
		_______, _______, _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, _______, _______,
		_______, _______, _______, KC_ENT , KC_ENT , KC_ENT , KC_ENT , _______, _______, _______, _______),
